...
var (
	queriesPaths = map[string]model.QueryConfig{
		...
		"../assets/queries/serverlessFW/common":     {FileKind: []model.FileKind{model.KindYAML, model.KindYML}, Platform: "serverlessFW"},
		"../assets/queries/serverlessFW/bom":        {FileKind: []model.FileKind{model.KindYAML, model.KindYML}, Platform: "serverlessFW"},
