...
The nightly release will have a "nightly" prefix with the last commit hash code. We have binaries available for both Windows, Linux and MacOS, as well a Docker image in <a href="https://hub.docker.com/r/checkmarx/kics" target="_blank">DockerHub</a>
