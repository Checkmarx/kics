...
CxPolicy[result] {
	...
	logs := document.resource.aws_eks_cluster[name].enabled_cluster_log_types
	...
	result := {
		...
		"resourceName": tf_lib.get_resource_name(document.resource.aws_eks_cluster[name], name),
