...
CxPolicy[result] {
    ...
    unrecommended_permission_policy_scenarios(targetRole, "ec2:RunInstances")
	...
	result := {
        ...
        "keyExpectedValue": sprintf("role %s is not associated with a policy that has Action set to 'ec2:RunInstances' and 'iam:PassRole' and Resource set to '*'", [targetRole]),
