  ...
  ingress_with_ipv6_cidr_blocks = [
    {
      ...
      to_port     = 22
      protocol    = "tcp"
      ipv6_cidr_blocks = ["2001:db8:abcd:0012::/124"]
    }
  ]
}
  ...
  ingress_with_cidr_blocks = [
    {
      ...
      to_port     = 2383
      protocol    = "udp"
      cidr_blocks = ["10.0.0.0/8", "1.2.3.4/27"]
    },
    {
      description = "TLS from VPC"
      from_port   = 28000
  ...
  ingress_with_ipv6_cidr_blocks = [
    {
      ...
      to_port     = 2383
      protocol    = "udp"
      ipv6_cidr_blocks = ["2001:0db8:85a3:0000:0000:8a2e:0370:7334/24", "2001:db8:abcd:0012::/123"]
    },
    {
      description = "TLS from VPC"
      from_port   = 28000
