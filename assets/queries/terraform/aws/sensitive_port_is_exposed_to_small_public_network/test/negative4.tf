  ...
  ingress_with_ipv6_cidr_blocks = [
    {
      ...
      to_port     = 0
      protocol    = "-1"
      ipv6_cidr_blocks = ["2002:0102:0304::/48","::/0"]
    }
  ]
}
  ...
  ingress_with_ipv6_cidr_blocks = [
    {
      ...
      to_port     = 2383
      protocol    = "udp"
      ipv6_cidr_blocks = ["2001:0db8:85a3:0000:0000:8a2e:0370:7334/24", "2401:fa00:4:1a::abcd/100"]
    },
    {
      description = "TLS from VPC"
      from_port   = 28000
    ...
    },
    {
      ...
      to_port     = 22
      protocol    = "tcp"
      ipv6_cidr_blocks = ["2001:0db8:85a3:0000:0000:8a2e:0370:7334/24"]
    }
  ]
}
