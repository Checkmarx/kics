...
CxPolicy[result] {
	...
	result := {
        ...
        "keyExpectedValue": sprintf("role %s shouldn't be associated with a policy that has Action set to 'cloudformation:CreateStack' and 'iam:PassRole' and Resource set to '*'", [targetRole]),
