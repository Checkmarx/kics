...
CxPolicy[result] {
	...
	result := {
        ...
        "keyExpectedValue": sprintf("group %s shouldn't be associated with a policy that has Action set to 'lambda:CreateFunction' and 'iam:PassRole' and 'lambda:InvokeFunction' and Resource set to '*'", [targetGroup]),
