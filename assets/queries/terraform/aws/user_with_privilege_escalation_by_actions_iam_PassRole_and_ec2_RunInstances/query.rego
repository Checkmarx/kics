...
CxPolicy[result] {
	...
	result := {
        ...
        "keyExpectedValue": sprintf("user %s shouldn't be associated with a policy that has Action set to 'ec2:RunInstances' and 'iam:PassRole' and Resource set to '*'", [targetUser]),
