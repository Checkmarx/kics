...
CxPolicy[result] {
    ...
    unrecommended_permission_policy_scenarios(targetGroup, "cloudformation:CreateStack")
	...
	result := {
        ...
        "keyExpectedValue": sprintf("group %s is not associated with a policy that has Action set to 'cloudformation:CreateStack' and 'iam:PassRole' and Resource set to '*'", [targetGroup]),
