...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": "kubernetes_deployment",
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("kubernetes_deployment[%s].spec.template.spec.affinity.pod_anti_affinity", [name]),
		"issueType": "MissingAttribute",
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": "kubernetes_deployment",
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("kubernetes_deployment[%s].spec.template.spec.affinity.pod_anti_affinity.preferred_during_scheduling_ignored_during_execution", [name]),
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": "kubernetes_deployment",
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("kubernetes_deployment[%s].spec.template.spec.affinity.pod_anti_affinity.preferred_during_scheduling_ignored_during_execution.match_labels", [name]),
		"issueType": "IncorrectValue",
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": "kubernetes_deployment",
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("kubernetes_deployment[%s].spec.template.spec.affinity.pod_anti_affinity.required_during_scheduling_ignored_during_execution", [name]),
		"issueType": "IncorrectValue",
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": "kubernetes_deployment",
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("kubernetes_deployment[%s].spec.template.spec.affinity.pod_anti_affinity.required_during_scheduling_ignored_during_execution.match_labels", [name]),
		"issueType": "IncorrectValue",
