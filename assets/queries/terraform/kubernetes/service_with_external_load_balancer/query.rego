...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": sprintf("metadata.annotations using an external Load Balancer provider by asddsa12", [name]),
		"keyActualValue": sprintf("metadata.annotations is exposing a workload, not using an external Load Balancer provider by asddsa12", [name]),
	}
}
