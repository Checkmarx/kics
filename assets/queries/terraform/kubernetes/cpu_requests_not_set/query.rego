...
CxPolicy[result] {
	...
	result := {
		...
		"searchLine": common_lib.build_search_line(array.concat(["resource", resourceType, name], split(specInfo.path, ".")), [types[x], y, "resources", "requests"]),
	}
}
...
CxPolicy[result] {
	...
	result := {
		...
		"searchLine": common_lib.build_search_line(array.concat(["resource", resourceType, name], split(specInfo.path, ".")), [types[x], "resources", "requests"]),
	}
}
