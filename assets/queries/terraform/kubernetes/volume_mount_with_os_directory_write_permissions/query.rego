...
CxPolicy[result] {
	...
	result := {
		...
		"searchKey": sprintf("%s[%s].%s.%s.name={{%s}}.volume_mount.read_only", [resourceType, name, specInfo.path, types[x], containers[y].name]),
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": resourceType,
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("%s[%s].%s.%s.name={{%s}}.volume_mount.name={{%s}}.read_only", [resourceType, name, specInfo.path, types[x], containers[y].name, volumeMounts[j].name]),
		"searchValue": sprintf("%d/%d", [y, j]),
		"issueType": "IncorrectValue",
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": resourceType,
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("%s[%s].%s.%s.volume_mount.name={{%s}}.read_only", [resourceType, name, specInfo.path, types[x], volumeMounts[j].name]),
		"searchValue": sprintf("%d", [j]),
		"issueType": "IncorrectValue",
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": resourceType,
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("%s[%s].%s.%s.name={{%s}}.volume_mount", [resourceType, name, specInfo.path, types[x], containers[y].name]),
		"searchValue": sprintf("%d", [y]),
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": resourceType,
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("%s[%s].%s.%s.name={{%s}}.volume_mount.name={{%s}}", [resourceType, name, specInfo.path, types[x], containers[y].name, volumeMounts[j].name]),
		"searchValue": sprintf("%d/%d", [y, j]),
		"issueType": "MissingAttribute",
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": resourceType,
		"resourceName": tf_lib.get_resource_name(resource, name),
		"searchKey": sprintf("%s[%s].%s.%s.volume_mount.name={{%s}}", [resourceType, name, specInfo.path, types[x], volumeMounts[j].name]),
		"searchValue": sprintf("%d", [j]),
		"issueType": "MissingAttribute",
