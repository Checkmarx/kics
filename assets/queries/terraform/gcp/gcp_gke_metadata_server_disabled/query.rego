...
CxPolicy[result] {
    ...
    result := {
        ...
        "searchLine": common_lib.build_search_line(["resource", "google_container_cluster", name, "node_config", "workload_metadata_config", "mode"], []),
...
CxPolicy[result] {
    ...
    result := {
        ...
        "searchLine": common_lib.build_search_line(["resource", "google_container_node_pool", name, "node_config", "workload_metadata_config", "mode"], []),
        "issueType": "IncorrectValue",
        "keyExpectedValue": "'mode' should be set to 'GKE_METADATA'",
        "keyActualValue": sprintf("'mode' is set to '%s'", [resource.node_config.workload_metadata_config.mode]),
    }
