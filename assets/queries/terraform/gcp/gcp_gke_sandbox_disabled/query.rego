...
CxPolicy[result] {
    ...
    result := {
        ...
        "searchLine": common_lib.build_search_line(["resource", "google_container_cluster", name, "node_config", "sandbox_config", "sandbox_type"], []),
...
CxPolicy[result] {
    ...
    result := {
        ...
        "searchLine": common_lib.build_search_line(["resource", "google_container_node_pool", name, "node_config", "sandbox_config", "sandbox_type"], []),
        "issueType": "IncorrectValue",
        "keyExpectedValue": "'sandbox_type' should be 'gvisor'",
        "keyActualValue": sprintf("'sandbox_type' is set to '%s'", [resource.node_config.sandbox_config.sandbox_type]),
    }
