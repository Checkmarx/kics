...
CxPolicy[result] {
    ...
    not has_flag_enabled(flags, "log_lock_waits")
    result := {
        ...
        "keyExpectedValue": sprintf("google_sql_database_instance[%s] should have database_flag log_lock_waits set to on", [name]),
        "keyActualValue": sprintf("google_sql_database_instance[%s] is missing log_lock_waits flag", [name]),
