...
CxPolicy[result] {
    ...
    result := {
        ...
        "searchLine": common_lib.build_search_line(["resource", "google_app_engine_standard_app_version", name, "handlers"], []),
...
CxPolicy[result] {
    ...
    result := {
        ...
        "searchLine": common_lib.build_search_line(["resource", "google_app_engine_standard_app_version", name], []),
