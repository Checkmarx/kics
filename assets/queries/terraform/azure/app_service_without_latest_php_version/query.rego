...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": "for the attribute 'php_version' should be the latest avaliable stable version (8.5)",
		"keyActualValue": "'php_version' is not the latest avaliable stable version (8.5)",
