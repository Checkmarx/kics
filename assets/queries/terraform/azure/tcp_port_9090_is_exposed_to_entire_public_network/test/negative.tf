...
resource "azurerm_network_security_rule" "example2" {
     ...
     protocol                    = "UDP"
     source_port_range           = "*"
     destination_port_range      = "9090-9101"
     source_address_prefix       = "*"
     destination_address_prefix  = "*"
     resource_group_name         = azurerm_resource_group.example.name
     network_security_group_name = azurerm_network_security_group.example.name
...
resource "azurerm_network_security_rule" "example3" {
     ...
     protocol                    = "TCP"
     source_port_range           = "*"
     destination_port_range      = "9075-9241"
...
resource "azurerm_network_security_rule" "example4" {
     ...
     protocol                    = "TCP"
     source_port_range           = "*"
     destination_port_range      = "9090-9263"
...
resource "azurerm_network_security_rule" "example8" {
     ...
     protocol                    = "*"
     source_port_range           = "*"
     destination_port_range      = "9089, 9091,18183-27268"
...
resource "azurerm_network_security_rule" "example10" {
     ...
     protocol                    = "TCP"
     source_port_range           = "*"
     destination_port_range      = "9090 ,  27270"
...
resource "azurerm_network_security_rule" "example11" {
     ...
     protocol                    = "TCP"
     source_port_range           = "*"
     destination_port_range      = "909,010"
     source_address_prefix       = "0.0.0.0"
     destination_address_prefix  = "*"
     resource_group_name         = azurerm_resource_group.example.name
     network_security_group_name = azurerm_network_security_group.example.name
