...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": "A 'azurerm_monitor_activity_log_alert' resource monitoring delete policy assignment events should be defined",
...
at_least_one_valid_log_alert(resources) {
	...
	resources[x].criteria.operation_name == "Microsoft.Authorization/policyAssignments/delete"
}
