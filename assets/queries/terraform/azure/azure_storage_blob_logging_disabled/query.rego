...
# CASE 1: The storage account has no Diagnostic Setting for Blobs.
CxPolicy[result] {
...
CxPolicy[result] {
    ...
    result := {
        ...
        "searchLine": common_lib.build_search_line(["resource", "azurerm_monitor_diagnostic_setting", diag_name], []),
        "issueType": "MissingAttribute",
...
CxPolicy[result] {
    ...
    result := {
        ...
        "searchLine": common_lib.build_search_line(["resource", "azurerm_monitor_diagnostic_setting", diag_name, "enabled_log"], []),
