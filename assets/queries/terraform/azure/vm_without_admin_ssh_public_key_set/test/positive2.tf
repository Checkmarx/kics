resource "azurerm_linux_virtual_machine_scale_set" "positive2_2_1" {
...
resource "azurerm_linux_virtual_machine_scale_set" "positive3_3" {
  name                = "positive3_3-machine"
  resource_group_name = azurerm_resource_group.positive3_3.name
  location            = azurerm_resource_group.positive3_3.location
  size                = "Standard_F2"
  admin_username      = "adminuser"
  network_interface_ids = [
    azurerm_network_interface.positive3_3.id,
  ]
