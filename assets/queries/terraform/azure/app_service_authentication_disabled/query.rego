...
resources := {"azurerm_linux_web_app", "azurerm_windows_web_app", "azurerm_app_service"}
...
prepare_issues(resource, type, name) = res { # auth_settings not defined for azurerm_app_service (legacy)
