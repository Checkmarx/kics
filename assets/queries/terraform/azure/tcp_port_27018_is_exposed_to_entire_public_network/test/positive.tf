...
resource "azurerm_network_security_rule" "example2" {
     ...
     protocol                    = "TCP"
     source_port_range           = "*"
     destination_port_range      = "27018-27029"
...
resource "azurerm_network_security_rule" "example3" {
     ...
     protocol                    = "*"
     source_port_range           = "*"
     destination_port_range      = "27016-27018"
     source_address_prefix       = "/0"
     destination_address_prefix  = "*"
     resource_group_name         = azurerm_resource_group.example.name
     network_security_group_name = azurerm_network_security_group.example.name
...
resource "azurerm_network_security_rule" "example5" {
     ...
     protocol                    = "TCP"
     source_port_range           = "*"
     destination_port_range      = "27018,27240"
...
resource "azurerm_network_security_rule" "example7" {
     ...
     protocol                    = "TCP"
     source_port_range           = "*"
     destination_port_range      = "27017-27059, 27089"
...
resource "azurerm_network_security_rule" "example8" {
     ...
     protocol                    = "TCP"
     source_port_range           = "*"
     destination_port_range      = "27009, 27018, 54038"
...
resource "azurerm_network_security_rule" "example9" {
     ...
     protocol                    = "*"
     source_port_range           = "*"
     destination_port_range      = "27007, 27018-27019,54036"
     source_address_prefix       = "/0"
     destination_address_prefix  = "*"
     resource_group_name         = azurerm_resource_group.example.name
     network_security_group_name = azurerm_network_security_group.example.name
...
resource "azurerm_network_security_rule" "example10" {
     ...
     protocol                    = "*"
     source_port_range           = "*"
     destination_port_range      = "54036-54136, 27013-27031, 1-2, 3"
