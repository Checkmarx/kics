...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": sprintf("Resources.%s.Properties.DistributionConfig.Enabled is 'true'", [name, name]),
...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": sprintf("Resources.%s.Properties.DistributionConfig contains an 'Origins' object", [name, name]),
