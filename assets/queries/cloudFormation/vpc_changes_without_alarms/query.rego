...
CxPolicy[result] {
	...
	not regex.match("{ *\\(\\$\\.eventName *= *CreateVpc\\) *\\|\\| *\\(\\$\\.eventName *= *DeleteVpc\\) *\\|\\| *\\(\\$\\.eventName *= *ModifyVpcAttribute\\) *\\|\\| *\\(\\$\\.eventName *= *AcceptVpcPeeringConnection\\) *\\|\\| *\\(\\$\\.eventName *= *CreateVpcPeeringConnection\\) *\\|\\| *\\(\\$\\.eventName *= *DeleteVpcPeeringConnection\\) *\\|\\| *\\(\\$\\.eventName *= *RejectVpcPeeringConnection\\) *\\|\\| *\\(\\$\\.eventName *= *AttachClassicLinkVpc\\) *\\|\\| *\\(\\$\\.eventName = DetachClassicLinkVpc\\) *\\|\\| *\\(\\$\\.eventName *= *DisableVpcClassicLink\\) *\\|\\| *\\(\\$\\.eventName = EnableVpcClassicLink\\) *}", resourceMetricFilter[name].Properties.FilterPattern)
