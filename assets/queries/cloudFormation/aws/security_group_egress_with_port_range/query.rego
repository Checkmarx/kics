...
CxPolicy[result] {
	...
	result := {
		...
		"issueType": "IncorrectValue",
		"keyExpectedValue": sprintf("Resources.%s.Properties.SecurityGroupEgress[%d].FromPort should be equal to Resources.%s.Properties.SecurityGroupEgress[%d].ToPort", [name, index, name, index]),
