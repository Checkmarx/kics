...
CxPolicy[result] {
	...
	not regex.match("{ *\\(\\$\\.eventName *= *CreateNetworkAcl\\) *\\|\\| *\\(\\$\\.eventName *= *CreateNetworkAclEntry\\) *\\|\\| *\\(\\$\\.eventName *= *DeleteNetworkAcl\\) *\\|\\| *\\(\\$\\.eventName *= *DeleteNetworkAclEntry\\) *\\|\\| *\\(\\$\\.eventName *= *ReplaceNetworkAclEntry\\) *\\|\\| *\\(\\$\\.eventName *= *ReplaceNetworkAclAssociation\\) *}", resourceMetricFilter[name].Properties.FilterPattern)
