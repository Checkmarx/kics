...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": resource.kind,
		"resourceName": resource.metadata.name,
		"searchKey": sprintf("metadata.name={{%s}}.spec.forProvider.management", [resource.metadata.name]),
		"issueType": "MissingAttribute",
...
CxPolicy[result] {
	...
	result := {
		...
		"resourceType": resource.kind,
		"resourceName": resource.metadata.name,
		"searchKey": sprintf("metadata.name={{%s}}.spec.forProvider.management.autoRepair", [resource.metadata.name]),
