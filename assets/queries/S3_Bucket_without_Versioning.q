...
result [ getMetadata({"id" : input.All[i].CxId, "data" : [b], "search": concat("+", ["aws_s3_bucket", name]) }) ] {
...
result [ getMetadata({"id" : input.All[i].CxId, "data" : [v], "search": concat("+", ["aws_s3_bucket", name]) }) ] {
