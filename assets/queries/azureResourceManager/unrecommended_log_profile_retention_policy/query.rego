...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": "resource with type 'microsoft.insights/logprofiles' should have 'enabled' property set to true",
...
CxPolicy[result] {
	...
	result := {
		...
		"issueType": "IncorrectValue",
		"keyExpectedValue": "resource with type 'microsoft.insights/logprofiles' should have 'days' property set to 0 or higher than 365",
