	...
	"queries": [
		{
			...
			"files": [
				{
					"file_name": "assets/queries/terraform/k8s/container_allow_privilege_escalation_is_true/test/positive.tf",
					...
					"locations": [
						{
							"physicalLocation": {
								"artifactLocation": {
									"uri": "assets/queries/terraform/k8s/container_allow_privilege_escalation_is_true/test/positive.tf"
								},
								"region": {
									"startLine": 11
								}
