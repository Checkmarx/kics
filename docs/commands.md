...
|      --fail-on strings             |  which kind of results should return an exit code different from 0<br>accepts: high, medium, low and info<br>example: "high,low" (default [critical,high,medium,low,info])|
