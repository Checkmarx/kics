...
Flags:
  ...
  -q, --queries-path string           path to directory with queries (default "./assets/queries")
      --report-formats strings        formats in which the results will be exported (all, cyclonedx, glsast, html, json, junit, pdf, sarif, sonarqube) (default [json])
  ...
  -t, --type strings                  case insensitive list of platform types to scan
                                      (Ansible, AzureResourceManager, CloudFormation, Dockerfile, GRPC, GoogleDeploymentManager, Kubernetes, OpenAPI, Terraform)
