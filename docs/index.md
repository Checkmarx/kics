...
<div class="row" >
    ...
    <div class="col-6 text-center">
        ...
        <p style="font-size:8pt">2021.12.20<p>
        <h4>Downloads:</h4>
        <a class="btn btn-success" href="https://github.com/Checkmarx/kics/releases/download/v1.4.9/kics_1.4.9_windows_x64.zip">Windows</a>
        <a class="btn btn-success" href="https://github.com/Checkmarx/kics/releases/download/v1.4.9/kics_1.4.9_linux_x64.tar.gz">Linux</a>
        <a class="btn btn-success" href="https://github.com/Checkmarx/kics/releases/download/v1.4.9/kics_1.4.9_darwin_x64.tar.gz">MacOS</a>
        <hr/>
