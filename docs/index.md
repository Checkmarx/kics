...
<div class="row" >
    ...
    <div class="col-6 text-center">
        <br/><br/>
        <h4>Version v1.4.1</h4>
        <p style="font-size:8pt">2021.08.18<p>
        <h4>Downloads:</h4>
        <a class="btn btn-success" href="https://github.com/Checkmarx/kics/releases/download/vv1.4.1/kics_v1.4.1_windows_x64.zip">Windows</a>
        <a class="btn btn-success" href="https://github.com/Checkmarx/kics/releases/download/vv1.4.1/kics_v1.4.1_linux_x64.tar.gz">Linux</a>
        <a class="btn btn-success" href="https://github.com/Checkmarx/kics/releases/download/vv1.4.1/kics_v1.4.1_darwin_x64.tar.gz">MacOS</a>
        <hr/>
