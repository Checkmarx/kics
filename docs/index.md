<div class="row" >
    <div class="col-6 text-center" >
        <img alt="KICS - Keeping Infrastructure as Code Secure" src="img/logo/kics_new_logo_2022_dark.png#only-light" width="500">
        <img alt="KICS - Keeping Infrastructure as Code Secure" src="img/logo/kics_new_logo_2022_white.png#only-dark" width="500">
        <br/>
         <br/>
    ...
    <div class="col-6 text-center">
        <br/><br/>
        <h4>Version 1.6.4</h4>
        <p style="font-size:8pt">2022.11.09<p>
