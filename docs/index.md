...
<div class="row" >
    ...
    <div class="col-6 text-center">
        ...
        <h4>Downloads:</h4>
        <a class="btn btn-success" href="https://github.com/Checkmarx/kics/releases/download/v1.4.1/kics_1.4.1_windows_x64.zip">Windows</a>
        <a class="btn btn-success" href="https://github.com/Checkmarx/kics/releases/download/v1.4.1/kics_1.4.1_linux_x64.tar.gz">Linux</a>
        <a class="btn btn-success" href="https://github.com/Checkmarx/kics/releases/download/v1.4.1/kics_1.4.1_darwin_x64.tar.gz">MacOS</a>
        <hr/>
