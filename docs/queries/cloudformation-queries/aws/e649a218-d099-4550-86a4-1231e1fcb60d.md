...
```yaml title="Postitive test num. 1 - yaml file" hl_lines="52"
...
```
```yaml title="Postitive test num. 2 - yaml file" hl_lines="35"
AWSTemplateFormatVersion: 2010-09-09
...
```
```yaml title="Postitive test num. 3 - yaml file" hl_lines="22"
AWSTemplateFormatVersion: "2010-09-09"
Parameters:
  DBUser:
    NoEcho: true
