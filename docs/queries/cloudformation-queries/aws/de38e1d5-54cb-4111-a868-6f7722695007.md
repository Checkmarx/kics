...
-   **URL:** [Github](https://github.com/Checkmarx/kics/tree/master/assets/queries/cloudFormation/aws/db_instance_publicly_accessible)
...
```yaml title="Postitive test num. 1 - yaml file" hl_lines="69"
...
```
```json title="Postitive test num. 2 - json file" hl_lines="61"
{
