...
```yaml title="Positive test num. 1 - yaml file" hl_lines="29 4 53"
Resources:
  NoIAM:
...
```
```yaml title="Positive test num. 2 - yaml file" hl_lines="4 29 55"
Resources:
  NoIAM:
    Type: AWS::EC2::Instance
    Properties:
...
```
```json title="Positive test num. 3 - json file" hl_lines="5 94 47"
{
  "Resources": {
    "NoIAM": {
      "Type": "AWS::EC2::Instance",
