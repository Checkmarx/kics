...
```yaml title="Postitive test num. 1 - yaml file" hl_lines="4 29 55"
Resources:
  NoIAM:
...
```
```json title="Postitive test num. 2 - json file" hl_lines="5 94 47"
{
  "Resources": {
    "NoIAM": {
      "Type": "AWS::EC2::Instance",
...
```
```yaml title="Postitive test num. 3 - yaml file" hl_lines="29 4 53"
Resources:
  NoIAM:
    Type: AWS::EC2::Instance
    Properties:
