...
-   **URL:** [Github](https://github.com/Checkmarx/kics/tree/master/assets/queries/cloudFormation/aws/api_gateway_v2_stage_access_logging_settings_not_defined)

### Description
API Gateway V2 Stage should have Access Logging Settings defined.<br>
