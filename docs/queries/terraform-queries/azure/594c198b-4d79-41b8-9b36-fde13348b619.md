...
-   **Query id:** 594c198b-4d79-41b8-9b36-fde13348b619
-   **Query name:** Sensitive Port Is Exposed To Entire Network
-   **Platform:** Terraform
-   **Severity:** <span style="color:#C00">High</span>
-   **Category:** Networking and Firewall
-   **URL:** [Github](https://github.com/Checkmarx/kics/tree/master/assets/queries/terraform/azure/sensitive_port_is_exposed_to_entire_network)
...
```tf title="Postitive test num. 1 - tf file" hl_lines="64 36 134 8 106 78 50 22 120 92"
