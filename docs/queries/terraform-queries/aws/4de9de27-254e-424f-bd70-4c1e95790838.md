...
```tf title="Postitive test num. 1 - tf file" hl_lines="11 28 36"
...
```
```tf title="Postitive test num. 2 - tf file" hl_lines="14 23"
module "asg" {
...
```
```tf title="Postitive test num. 3 - tf file" hl_lines="24 18"
module "asg" {
  source = "terraform-aws-modules/autoscaling/aws"
  version = "1.0.4"
