...
```tf title="Postitive test num. 1 - tf file" hl_lines="118"
terraform {
  required_providers {
    aws = {
...
```
```tf title="Postitive test num. 2 - tf file" hl_lines="132"
terraform {
  required_providers {
    aws = {
      source  = "hashicorp/aws"
...
```
```tf title="Postitive test num. 3 - tf file" hl_lines="118"
terraform {
  required_providers {
    aws = {
      source  = "hashicorp/aws"
