...
-   **Query id:** 21719347-d02b-497d-bda4-04a03c8e5b61
...
-   **URL:** [Github](https://github.com/Checkmarx/kics/tree/master/assets/queries/terraform/kubernetes/memory_requests_not_defined)
...
```tf title="Positive test num. 1 - tf file" hl_lines="195 231 296 138 12 109 51 408 350"
