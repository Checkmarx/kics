...
```yaml title="Positive test num. 1 - yaml file" hl_lines="14 15"
openapi: "3.0.2"
info:
  title: POI Search
  version: "1.0.1"
...
```
```json title="Positive test num. 2 - json file" hl_lines="18 52"
{
  "openapi": "3.0.0",
  "info": {
...
```
```json title="Positive test num. 3 - json file" hl_lines="41 55"
{
  "swagger": "2.0",
  "info": {
    "title": "Simple API Overview",
