...
```json title="Postitive test num. 1 - json file" hl_lines="42"
{
  "openapi": "3.0.0",
  "info": {
...
```
```yaml title="Postitive test num. 2 - yaml file" hl_lines="28"
openapi: 3.0.0
info:
  title: Simple API overview
  version: 1.0.0
...
```
```json title="Postitive test num. 3 - json file" hl_lines="32 14"
{
  "swagger": "2.0",
  "info": {
    "title": "Simple API Overview",
