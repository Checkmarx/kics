...
```json title="Postitive test num. 1 - json file" hl_lines="56"
{
  "openapi": "3.0.0",
  "info": {
...
```
```yaml title="Postitive test num. 2 - yaml file" hl_lines="38"
openapi: 3.0.0
info:
  title: Simple API Overview
  version: 1.0.0
...
```
```json title="Postitive test num. 3 - json file" hl_lines="54"
{
  "openapi": "3.0.0",
  "info": {
    "title": "Simple API overview",
