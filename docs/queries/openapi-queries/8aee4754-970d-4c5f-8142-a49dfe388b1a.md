...
```json title="Postitive test num. 1 - json file" hl_lines="38"
{
  "openapi": "3.0.0",
  "info": {
...
```
```json title="Postitive test num. 2 - json file" hl_lines="35"
{
  "openapi": "3.0.0",
  "info": {
    "title": "Simple API Overview",
...
```
```yaml title="Postitive test num. 3 - yaml file" hl_lines="30"
openapi: 3.0.0
info:
  title: Simple API Overview
  version: 1.0.0
