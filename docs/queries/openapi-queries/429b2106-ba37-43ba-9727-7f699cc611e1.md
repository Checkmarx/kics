...
```json title="Postitive test num. 1 - json file" hl_lines="40 20"
{
  "swagger": "2.0",
  "info": {
...
```
```json title="Postitive test num. 2 - json file" hl_lines="25 7"
{
  "swagger": "2.0",
  "info": {
    "title": "Simple API Overview",
...
```
```yaml title="Postitive test num. 3 - yaml file" hl_lines="16 28"
swagger: "2.0"
info:
  title: Simple API Overview
  version: 1.0.0
