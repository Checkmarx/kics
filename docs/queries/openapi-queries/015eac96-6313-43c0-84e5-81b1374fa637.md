---
title: Schema JSON Reference Does Not Exists (v3)
hide:
  toc: true
  navigation: true
---
...
-   **Query name:** Schema JSON Reference Does Not Exists (v3)
-   **Platform:** OpenAPI
...
### Description
Schema reference should exists on components field<br>
