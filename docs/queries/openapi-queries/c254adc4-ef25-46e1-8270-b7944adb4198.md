...
```json title="Postitive test num. 1 - json file" hl_lines="46 15"
{
  "openapi": "3.0.0",
  "info": {
...
```
```yaml title="Postitive test num. 2 - yaml file" hl_lines="8 25"
openapi: 3.0.0
info:
  title: Simple API overview
  version: 1.0.0
...
```
```json title="Postitive test num. 3 - json file" hl_lines="23 15"
{
  "swagger": "2.0",
  "info": {
    "title": "Simple API Overview",
