...
```json title="Positive test num. 1 - json file" hl_lines="19 20 21"
{
  "openapi": "3.0.0",
  "info": {
...
```
```yaml title="Positive test num. 2 - yaml file" hl_lines="16 14 15"
openapi: 3.0.0
info:
  title: Simple API overview
  version: 1.0.0
...
```
```json title="Positive test num. 3 - json file" hl_lines="19 20"
{
  "swagger": "2.0",
  "info": {
    "title": "Simple API overview",
