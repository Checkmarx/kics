...
```yaml title="Postitive test num. 1 - yaml file" hl_lines="19 6"
openapi: 3.0.0
info:
...
```
```json title="Postitive test num. 2 - json file" hl_lines="8 29"
{
  "openapi": "3.0.0",
  "info": {
    "title": "Simple API overview",
...
```
```yaml title="Postitive test num. 3 - yaml file" hl_lines="10 21"
swagger: "2.0"
info:
  title: Simple API Overview
  version: 1.0.0
