...
```json title="Postitive test num. 1 - json file" hl_lines="43 55"
{
  "openapi": "3.0.0",
  "info": {
...
```
```yaml title="Postitive test num. 2 - yaml file" hl_lines="40 26"
openapi: 3.0.0
info:
  title: Simple API overview
  version: 1.0.0
...
```
```json title="Postitive test num. 3 - json file" hl_lines="10"
{
  "openapi": "3.0.0",
  "info": {
    "title": "Simple API overview",
