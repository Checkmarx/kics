...
```json title="Postitive test num. 1 - json file" hl_lines="58 77 62"
{
  "openapi": "3.0.0",
  "info": {
...
```
```json title="Postitive test num. 2 - json file" hl_lines="27 31"
{
  "openapi": "3.0.0",
  "info": {
    "title": "Simple API Overview",
...
```
```yaml title="Postitive test num. 3 - yaml file" hl_lines="34 37 47"
openapi: 3.0.0
info:
  title: Simple API Overview
  version: 1.0.0
