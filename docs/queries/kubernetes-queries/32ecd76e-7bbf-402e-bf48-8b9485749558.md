...
-   **URL:** [Github](https://github.com/Checkmarx/kics/tree/master/assets/queries/k8s/token_auth_file_is_set)

### Description
When using kube-apiserver command, the 'token-auth-file' flag should not be set<br>
