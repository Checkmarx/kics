...
func (c *Client) createService(
	...
	combinedParser, err := parser.NewBuilder().
		Add(&jsonParser.Parser{ScanSourcePaths: c.ScanParams.Path, StrictSourceResolver: c.ScanParams.StrictSourceResolution}).
		Add(&yamlParser.Parser{ScanSourcePaths: c.ScanParams.Path, StrictSourceResolver: c.ScanParams.StrictSourceResolution}).
		Add(terraformParser.NewDefaultWithVarsPath(c.ScanParams.TerraformVarsPath, c.ScanParams.Path, c.ScanParams.StrictSourceResolution)).
