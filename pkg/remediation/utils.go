...
func willRemediate(remediated []string, originalFileName string, remediation *Remediation, resolveReferences bool) bool {
	...
	results, err := scanTmpFile(tmpFile, remediation.QueryID, content, resolveReferences)
