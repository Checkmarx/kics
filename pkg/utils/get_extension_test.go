...
func TestGetExtension(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name:     "Get extension from a file named as dockerFILE and without extension defined ('dockerFILE')",
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/any_name/dockerFILE",
			toCreate: false,
			err:      nil,
		},
		{
			...
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/any_name/file.Dockerfile",
			toCreate: false,
			err:      nil,
		},
		{
			...
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/any_name/file_2.DOCKERfile",
			toCreate: false,
			err:      nil,
		},
		{
			...
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/any_name/Dockerfile.something",
			toCreate: false,
			err:      nil,
		},
		{
			...
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/any_name/DOCKERfile.txt",
			toCreate: false,
			err:      nil,
		},
		{
		...
		},
		{
			...
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/any_name/random_name",
			toCreate: false,
			err:      nil,
		},
		{
			...
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/any_name/any_name.ubi8",
			toCreate: false,
			err:      nil,
		},
		{
			...
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/any_name/any_name.debian",
			toCreate: false,
			err:      nil,
		},
		{
		...
		{
			name:     "(Case_insensitive_tests) -- Get extension from a file named as dockerFILE and without extension defined ('dockerFILE')",
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/case_insensitive_tests/dockerFILE",
			toCreate: false,
			err:      nil,
		},
		{
			name:     "(Case_insensitive_tests) -- Get extension from a file not named 'dockerfile' with extension defined as Dockerfile ('file.Dockerfile')",
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/case_insensitive_tests/file.Dockerfile",
			toCreate: false,
			err:      nil,
		},
		{
			name:     "(Case_insensitive_tests) -- Get extension from a file not named 'dockerfile' with extension defined as DOCKERfile ('file_2.DOCKERfile')",
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/case_insensitive_tests/file_2.DOCKERfile",
			toCreate: false,
			err:      nil,
		},
		{
			name:     "(Case_insensitive_tests) -- Get extension from a file named 'Dockerfile' with any extension defined ('Dockerfile.something')",
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/case_insensitive_tests/Dockerfile.something",
			toCreate: false,
			err:      nil,
		},
		{
			name:     "(Case_insensitive_tests) -- Get extension from a file named 'DOCKERfile' with any extension defined ('DOCKERfile.txt')",
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/case_insensitive_tests/DOCKERfile.txt",
			toCreate: false,
			err:      nil,
		},
		{
			name:     "(Case_insensitive_tests) -- Get extension from a file not named as Dockerfile and without extension defined ('random_name'), due to parent folder scan will identify dockerfile syntax regardless",
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/case_insensitive_tests/random_name",
			toCreate: false,
			err:      nil,
		},
		{
			name:     "(Case_insensitive_tests) -- Get extension from a valid text file with dockerfile syntax and '.ubi8' extension ('any_name.ubi8')",
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/case_insensitive_tests/any_name.ubi8",
			toCreate: false,
			err:      nil,
		},
		{
			name:     "(Case_insensitive_tests) -- Get extension from a valid text file with dockerfile syntax and '.debian' extension ('any_name.debian')",
			want:     ".dockerfile",
			filePath: "../../test/fixtures/dockerfile/case_insensitive_tests/any_name.debian",
			toCreate: false,
			err:      nil,
		},
	}
