...
func (p *Parser) Resolve(fileContent []byte, filename string, resolveReferences bool, resolverDepth int) ([]byte, error) {
	...
	resolved := res.Resolve(fileContent, filename, 0, resolvedFilesCache, resolveReferences, resolverDepth)
