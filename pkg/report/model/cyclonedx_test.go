...
func TestBuildCycloneDxReport(t *testing.T) {
	...
	v1 := Vulnerability{
		...
		Recommendations: []Recommendation{
			{
				Recommendation: "In line 1, the actual value is 'aws_guardduty_detector[{{positive1}}].tags is undefined or null'. However, the expected value is 'aws_guardduty_detector[{{positive1}}].tags is defined and not null'",
			},
		},
	}
	...
	v2 := Vulnerability{
		...
		Recommendations: []Recommendation{
			{
				Recommendation: "In line 2, the actual value is 'GuardDuty Detector is not Enabled'. However, the expected value is 'GuardDuty Detector should be Enabled'",
			},
		},
	}
	...
	v3 := Vulnerability{
		...
		Recommendations: []Recommendation{
			{
				Recommendation: "In line 1, the actual value is 'aws_guardduty_detector[{{negative1}}].tags is undefined or null'. However, the expected value is 'aws_guardduty_detector[{{negative1}}].tags is defined and not null'",
			},
		},
	}
