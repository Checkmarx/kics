...
from pymarshal.json import unmarshal_dict
...
def validate_scan_results(query_dir):
    ...
    scan_results = unmarshal_dict(data, ScanResults)
    print("[DEBUG] After unmarshal_dict")
